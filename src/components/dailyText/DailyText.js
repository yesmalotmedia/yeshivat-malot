...
const DailyText = () => {
  ...
  const styles = {
    container: {
      ...
      alignItems: "center",
      transform: screenWidth < 1400 ? "translateY(0px)" : "translateY(50px)",
    },
    textContainer: { padding: responsive(10, 60, 20) },
    text: {
      margin: "auto",
      marginTop: 50,
      color: colors.darkBlue,
      fontSize: responsive("2.3rem", "1.7rem", "1.4rem"),
      fontWeight: 600,
    ...
    textSource: {
      ...
      color: colors.darkBlue,
      fontWeight: 300,
      fontSize: responsive("2rem", "1.7rem", "1.4rem"),
      animation: "fadeInOut 10s infinite",
    },
    bgImg: {
      width: responsive("30%", "70%", "100%"),
      position: "absolute",
      bottom: 0,
      left: 0,
      zIndex: -10,
